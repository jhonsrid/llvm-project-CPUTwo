...
// expected-error@-1 {{'__ptrauth' options argument has an unexpected comma after 'strip'}}
int *__ptrauth(VALID_DATA_KEY, 1, 65535, "strip,") invalid19;
// expected-error@-1 {{'__ptrauth' options argument has an trailing comma after 'strip'}}
...
// expected-error@-1 2 {{'__ptrauth' options argument has an unexpected comma}}
// expected-error@-2 {{'__ptrauth' options argument has an trailing comma}}
int *__ptrauth(VALID_DATA_KEY, 1, 65535, "strip isa-pointer") invalid22;
// expected-error@-1 {{'__ptrauth' options argument expected a comma after 'strip'}}
int *__ptrauth(VALID_DATA_KEY, 1, 65535, "strip\nisa-pointer") invalid23;
// expected-error@-1 {{'__ptrauth' options argument expected a comma after 'strip'}}
int *__ptrauth(VALID_DATA_KEY, 1, 65535, "strip"
                                         " isa-pointer") invalid24;
// expected-error@-2{{'__ptrauth' options argument expected a comma after 'strip'}}
int *__ptrauth(VALID_DATA_KEY, 1, 0, "sign-and-strip,\n,isa-pointer") invalid25; // expected-error{{'__ptrauth' options argument has an unexpected comma after 'sign-and-strip'}}
int *__ptrauth(VALID_DATA_KEY, 1, 0, "sign-and-strip,\t,isa-pointer") invalid26; // expected-error{{'__ptrauth' options argument has an unexpected comma after 'sign-and-strip'}}
