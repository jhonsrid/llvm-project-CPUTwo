...
int *__ptrauth(VALID_DATA_KEY, 1, 65535, 41) invalid11;          // expected-error {{'__ptrauth' options argument is not a constant string}}
int *__ptrauth(VALID_DATA_KEY, 1, nonConstantGlobal) invalid12;  // expected-error {{argument to '__ptrauth' must be an integer constant expression}}
...
int *__ptrauth(VALID_DATA_KEY, 1, 65535, "strip,") invalid19;                   // expected-error {{'__ptrauth' options argument has an trailing comma after 'strip'}}
int *__ptrauth(VALID_DATA_KEY, 1, 65535, ",") invalid20;                        // expected-error {{'__ptrauth' options argument has an unexpected comma}}
                                                                                // expected-error@-1 {{'__ptrauth' options argument has an trailing comma}}
int *__ptrauth(VALID_DATA_KEY, 1, 65535, ",,") invalid21;                       // expected-error {{'__ptrauth' options argument has an unexpected comma}}
                                                                                // expected-error@-1 {{'__ptrauth' options argument has an unexpected comma}}
                                                                                // expected-error@-2 {{'__ptrauth' options argument has an trailing comma}}
int *__ptrauth(VALID_DATA_KEY, 1, 65535, "strip isa-pointer") invalid22;        // expected-error {{'__ptrauth' options argument expected a comma after 'strip'}}
int *__ptrauth(VALID_DATA_KEY, 1, 65535, "strip\nisa-pointer") invalid23;       // expected-error {{'__ptrauth' options argument expected a comma after 'strip'}}
int *__ptrauth(VALID_DATA_KEY, 1, 65535, "strip"                                // expected-error {{'__ptrauth' options argument expected a comma after 'strip'}}
                                         " isa-pointer") invalid24;
int *__ptrauth(VALID_DATA_KEY, 1, 0, "sign-and-strip,\n,isa-pointer") invalid25; // expected-error {{'__ptrauth' options argument has an unexpected comma}}
int *__ptrauth(VALID_DATA_KEY, 1, 0, "sign-and-strip,\t,isa-pointer") invalid26; // expected-error {{'__ptrauth' options argument has an unexpected comma}}
